            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="create-button-container">
                        <a href="{{route('users.create')}}" class="py-2 px-4 mt-8 bg-indigo-500 text-white rounded-md shadow-xl">Create</a>
                    </div>
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100 {{($index%2 == 0) ? '' : 'bg-gray-50'}}">
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                <a href="{{route('users.edit', ['user' => $user->id])}}" class="w-4 mr-2 transform hover:text-purple-400 hover:scale-110">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                    </svg>
                                                </a>
                                                <button onclick="deleteUser({{$user->id}})" class="w-4 mr-2 transform hover:text-purple-400 hover:scale-110">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            function deleteUser(userId){
              ...
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  let deleteForm =
                    `
                    <form id="remove-form" method="POST" action="users/${userId}">
